...
public class DBHelper extends SQLiteOpenHelper {
    ...
    //修改密码
    public void changePwd(User user, String edt_new_pwd) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_USERPWD, edt_new_pwd);
        db.update(TABLE_NAME, values, COLUMN_USERID+"=?", new String[]{user.getUserId()});
    }
